...
class List extends React.Component {
 ...
 <div className="card   mb-3 mb-3" style={{maxWidth: "20rem",marginTop:'20px'}}>
 ...
 <div className="card-reveal">
   ...
   <h5>username 2</h5><p> {user.un2}</p>
    ...
    <button className="btn btn-sm btn-danger" onClick={(e) => dispatchDeleteUser(e, id)} style={{float:"Left"}}>Delete</button>
